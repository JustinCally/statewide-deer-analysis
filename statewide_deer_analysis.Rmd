...
```{r Operation, fig.height = 8, fig.width = 5, fig.cap="Deployment times of the cameras across the survey period"}
seasons <- data.frame(Date=seq.Date(from = as.Date("2021-08-01"), 
                               to = as.Date("2023-07-01"), by = "month"),
                 Season = c('Winter',
                            ...
                            'Autumn', 'Autumn', 'Autumn',
                            'Winter', 'Winter')) %>%
  mutate(DateEnd = seq.Date(from = as.Date("2021-09-01"), 
                               to = as.Date("2023-08-01"), by = "month"), 
