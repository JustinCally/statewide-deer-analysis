...
levels(gormleySambarOcc2) <- data.frame(id = 1, values = "2011: Gormley et al (38,582 km^2^)")
...
sambar_change_plot <- ggplot() +
  ...
  ggspatial::annotation_scale() +
  ggplot2::scale_fill_manual(values = c(`2011: Gormley et al (38,582 km^2^)` = "#71C5E8", 
