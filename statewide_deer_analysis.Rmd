...
# Simple Formula with Climate and Coastal Distance (for hog deer)
ab_formula_4 <- ~ scale(sqrt(BareSoil)) + scale(sqrt(Nitrogen)) + scale(sqrt(PastureDistance)) + scale(TreeDensity) + scale(sqrt(ForestEdge)) + scale(BIO12) + scale(I(BIO12^2)) + scale(dist_coast) 
